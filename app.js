const canvas = document.getElementById('game');
    ...
    function drawBackProps() {
      ...
      if (level.skyStyle === 'forest') {
        for (let i = 0; i < 24; i++) {
          ...
          const trunkGrad = ctx.createLinearGradient(x + 10, y - 104, x + 38, y + 28);
          trunkGrad.addColorStop(0, 'rgba(108, 82, 58, 0.34)');
          trunkGrad.addColorStop(0.45, 'rgba(77, 56, 38, 0.3)');
          trunkGrad.addColorStop(1, 'rgba(47, 33, 24, 0.28)');
          ctx.fillStyle = trunkGrad;
          roundRect(x + 15, y - 104, 20, 138, 10);
          ctx.fill();
          ctx.fillStyle = 'rgba(41, 86, 58, 0.2)';
          ctx.beginPath();
          ...
          ctx.closePath();
          ctx.fill();
          ctx.fillStyle = 'rgba(70, 145, 96, 0.24)';
          for (let j = 0; j < 7; j++) {
            ctx.beginPath();
            ctx.ellipse(x + 24 + (j - 3) * 16, y - 102 + Math.abs(j - 3) * 8, 28, 10, (j - 3) * 0.36, 0, Math.PI * 2);
            ctx.fill();
          }
          ctx.fillStyle = 'rgba(121, 190, 132, 0.16)';
          for (let j = 0; j < 4; j++) {
            ctx.beginPath();
            ctx.ellipse(x + 8 + j * 11, y - 80 + (j % 2) * 7, 18, 6, -0.28 + j * 0.12, 0, Math.PI * 2);
            ctx.fill();
          }
          if (i % 3 === 1) {
            ctx.fillStyle = 'rgba(108, 86, 69, 0.18)';
            roundRect(x - 20, y - 30, 78, 62, 10);
            ctx.fill();
            ctx.fillStyle = 'rgba(153, 205, 183, 0.11)';
            roundRect(x - 6, y - 18, 24, 24, 6);
            ctx.fill();
            ctx.fillStyle = 'rgba(0, 0, 0, 0.08)';
            roundRect(x + 18, y - 4, 12, 16, 4);
            ctx.fill();
          }
          if (i % 4 === 2) {
            ctx.strokeStyle = 'rgba(109, 178, 128, 0.18)';
            ctx.lineWidth = 3;
            ctx.beginPath();
            ctx.moveTo(x + 30, y - 54);
            ctx.quadraticCurveTo(x + 44, y - 24, x + 38, y + 20);
            ctx.stroke();
            ctx.beginPath();
            ctx.moveTo(x + 20, y - 46);
            ctx.quadraticCurveTo(x + 6, y - 14, x + 10, y + 18);
            ctx.stroke();
          }
        }
      } else {
        for (let i = 0; i < 18; i++) {
          ...
          const monolithGrad = ctx.createLinearGradient(x + 16, y - 140, x + 78, y);
          monolithGrad.addColorStop(0, level.skyStyle === 'storm' ? 'rgba(96, 113, 150, 0.28)' : 'rgba(53, 87, 96, 0.28)');
          monolithGrad.addColorStop(1, level.skyStyle === 'storm' ? 'rgba(44, 54, 84, 0.18)' : 'rgba(25, 49, 58, 0.2)');
          ...
          ctx.closePath();
          ctx.fill();
          ctx.fillStyle = level.skyStyle === 'storm' ? 'rgba(207, 223, 255, 0.12)' : 'rgba(117, 233, 246, 0.12)';
          ctx.beginPath();
          ...
          ctx.closePath();
          ctx.fill();
          ctx.fillStyle = level.skyStyle === 'storm' ? 'rgba(156, 190, 255, 0.09)' : 'rgba(126, 240, 255, 0.1)';
          ctx.beginPath();
          ...
          ctx.fill();
          if (i % 3 === 0) {
            ctx.fillStyle = 'rgba(129, 153, 170, 0.14)';
            roundRect(x + 92, y - 78, 42, 84, 10);
            ctx.fill();
            ctx.fillStyle = 'rgba(87, 111, 126, 0.14)';
            roundRect(x + 101, y - 60, 24, 20, 6);
            ctx.fill();
            ctx.fillStyle = 'rgba(211, 240, 255, 0.08)';
            roundRect(x + 100, y - 28, 26, 22, 6);
            ctx.fill();
          }
          if (i % 4 === 1) {
            ctx.strokeStyle = level.skyStyle === 'storm' ? 'rgba(180, 202, 255, 0.1)' : 'rgba(127, 236, 247, 0.12)';
            ctx.lineWidth = 3;
            ctx.beginPath();
            ctx.moveTo(x + 96, y - 12);
            ctx.quadraticCurveTo(x + 118, y - 42, x + 140, y - 12);
            ctx.stroke();
          }
        }
      }
    ...
    function drawForegroundFoliage() {
      ...
      if (level.skyStyle === 'forest') {
        for (let i = 0; i < 16; i++) {
          ...
          ctx.fillStyle = 'rgba(88, 161, 96, 0.14)';
          ctx.beginPath();
          ctx.ellipse(x + 28, baseY - 34, 34, 12, 0.08, 0, Math.PI * 2);
          ctx.fill();
    ...
    function drawEnemy(e) {
      ...
      if (e.type === 'beetle') {
        ctx.strokeStyle = '#4f2d53';
        ctx.lineWidth = 3;
        ctx.lineCap = 'round';
        ctx.beginPath();
        ctx.moveTo(-10, 11); ctx.lineTo(-18, 16);
        ctx.moveTo(-4, 13); ctx.lineTo(-10, 18);
        ctx.moveTo(10, 11); ctx.lineTo(18, 16);
        ctx.moveTo(4, 13); ctx.lineTo(10, 18);
        ctx.stroke();
        const shellGrad = ctx.createLinearGradient(-14, -8, 12, 16);
        shellGrad.addColorStop(0, '#caa7df');
        shellGrad.addColorStop(0.5, '#7e4d8b');
        shellGrad.addColorStop(1, '#47264e');
        ctx.fillStyle = '#3a223e';
        ctx.beginPath();
        ...
        ctx.fill();
        ctx.strokeStyle = 'rgba(255, 240, 255, 0.28)';
        ctx.lineWidth = 1.4;
        ctx.beginPath();
        ctx.moveTo(0, -8);
        ctx.lineTo(0, 14);
        ctx.stroke();
        ctx.fillStyle = 'rgba(238, 219, 244, 0.88)';
        ctx.beginPath();
        ctx.ellipse(-5, -1, 5.5, 3.8, -0.22, 0, Math.PI * 2);
        ctx.ellipse(5, -1, 5.5, 3.8, 0.22, 0, Math.PI * 2);
        ctx.fill();
        ...
        const shellGrad = ctx.createRadialGradient(-6, 2, 2, -6, 2, 12);
        shellGrad.addColorStop(0, '#e4c59d');
        shellGrad.addColorStop(0.55, '#b47e4e');
        shellGrad.addColorStop(1, '#6f472b');
        ctx.fillStyle = '#d7c2a4';
        ctx.beginPath();
        ctx.moveTo(-16, 11);
        ctx.quadraticCurveTo(2, 15, 18, 10);
        ctx.quadraticCurveTo(16, 2, -8, 2);
        ...
        ctx.fill();
        ctx.strokeStyle = '#845734';
        ctx.lineWidth = 3;
        ctx.beginPath();
        ctx.arc(-5, 3, 5.5, Math.PI * 0.25, Math.PI * 2);
        ctx.stroke();
        ctx.beginPath();
        ctx.moveTo(6, -2);
        ctx.lineTo(12, -11);
        ...
        ctx.beginPath();
        ctx.arc(12, -11, 1.9, 0, Math.PI * 2);
        ctx.arc(18, -10, 1.9, 0, Math.PI * 2);
        ctx.fill();
      } else if (e.type === 'bat') {
        const wingGrad = ctx.createLinearGradient(-24, -10, 24, 12);
        wingGrad.addColorStop(0, '#90a4e0');
        wingGrad.addColorStop(0.45, '#5b6da5');
        wingGrad.addColorStop(1, '#34415f');
        ctx.fillStyle = wingGrad;
        ctx.beginPath();
        ctx.moveTo(-6, 1);
        ctx.quadraticCurveTo(-24, -15, -25, 9);
        ctx.quadraticCurveTo(-16, 6, -10, 10);
        ctx.quadraticCurveTo(-8, 6, -6, 1);
        ctx.fill();
        ctx.beginPath();
        ctx.moveTo(6, 1);
        ctx.quadraticCurveTo(24, -15, 25, 9);
        ...
        const bodyGrad = ctx.createLinearGradient(-18, 0, 16, 18);
        bodyGrad.addColorStop(0, '#86c870');
        bodyGrad.addColorStop(0.55, '#5d9a58');
        bodyGrad.addColorStop(1, '#3c6338');
        ctx.fillStyle = bodyGrad;
        ctx.beginPath();
        ctx.ellipse(1, 7, 18, 11, 0, 0, Math.PI * 2);
        ctx.fill();
        ctx.fillStyle = '#d7f0bf';
        ctx.beginPath();
        ctx.ellipse(-6, 3, 8, 5, 0, 0, Math.PI * 2);
        ctx.fill();
        ctx.fillStyle = 'rgba(220, 244, 191, 0.26)';
        ctx.beginPath();
        ctx.ellipse(4, 2, 5, 3, 0.2, 0, Math.PI * 2);
        ctx.fill();
        ctx.strokeStyle = '#4f7247';
        ctx.lineWidth = 3;
        ctx.beginPath();
        ctx.moveTo(-6, -1);
        ctx.lineTo(7, -5);
    ...
    function drawFrog() {
      ...
      ctx.fill();
      ctx.strokeStyle = 'rgba(66, 42, 24, 0.46)';
      ctx.lineWidth = 1.8;
      ctx.beginPath();
      ctx.ellipse(0, 10 - bounce + crouch * 0.2, 16.5, 18, 0, 0, Math.PI * 2);
      ctx.stroke();
      ...
      ctx.fill();
      ctx.fillStyle = 'rgba(241, 222, 177, 0.2)';
      [[-10, -12, 2.8, 4.1], [8, -11, 2.6, 3.8], [-4, -16, 2.2, 3.2], [6, -17, 2.2, 3.2]].forEach(([sx, sy, rx, ry]) => {
        ctx.beginPath();
        ctx.ellipse(sx, sy - bounce, rx, ry, 0.2, 0, Math.PI * 2);
        ctx.fill();
      });
      ctx.fillStyle = 'rgba(233, 188, 120, 0.18)';
      ctx.beginPath();
      ctx.ellipse(0, -3 - bounce, 4.2, 8.5, 0, 0, Math.PI * 2);
      ctx.fill();
      ...
      ctx.beginPath();
      ctx.arc(-10.6, -20.3 - bounce, 0.95, 0, Math.PI * 2);
      ctx.arc(8.8, -20.4 - bounce, 0.95, 0, Math.PI * 2);
      ctx.fill();
      ...
      ctx.lineTo(24, 12 - bounce);
      ctx.stroke();
      ctx.strokeStyle = 'rgba(239, 216, 171, 0.18)';
      ctx.lineWidth = 1.8;
      ctx.beginPath();
      ctx.moveTo(-8, 12 - bounce);
      ctx.lineTo(-15, 18 + legSwing - bounce);
      ctx.moveTo(8, 12 - bounce);
      ctx.lineTo(16, 18 - legSwing - bounce);
      ctx.moveTo(-10, 0 - bounce);
      ctx.lineTo(-16, 6 - armSwing - bounce);
      ctx.moveTo(10, 0 - bounce);
      ctx.lineTo(16, 6 + armSwing - bounce);
      ctx.stroke();
      ...
      [[-24, 12], [-22, 24], [24, 12], [24, 24]].forEach(([tx, ty]) => {
        ctx.beginPath();
        ctx.arc(tx - 1.1, ty - bounce - 1.1, 1.2, 0, Math.PI * 2);
        ctx.fill();
      });
